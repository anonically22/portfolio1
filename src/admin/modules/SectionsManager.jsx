      ...
      {loading ? (
        ...
        <div className="grid gap-8">
          {sections.map((section) => (
            <div key={section.id} className="p-8 bg-white dark:bg-accent-light rounded-3xl border border-border shadow-sm space-y-6">
              <div className="flex justify-between items-center pb-4 border-b border-border">
                ...
                <button 
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl transition-all font-bold text-sm ${
                    section.enabled ? 'bg-green-500/10 text-green-600' : 'bg-red-500/10 text-red-600'
                  }`}
                >
